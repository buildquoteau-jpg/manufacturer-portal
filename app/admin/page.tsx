  ...
  return (
    <div className="min-h-screen bg-page">
      ...
      <div className="sticky top-0 z-30 bg-surface border-b border-border px-6 py-4">
        <div className="max-w-4xl xl:max-w-6xl 2xl:max-w-[1480px] mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <a href="/" className="text-text-faint hover:text-text-primary text-xs transition-colors">← Portal home</a>
      ...
      <div className="border-b border-border bg-surface">
        <div className="max-w-4xl xl:max-w-6xl 2xl:max-w-[1480px] mx-auto px-6">
